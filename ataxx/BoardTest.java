...
public class BoardTest {
    ...
    private static void checkBoard(Board b, PieceColor[][] expectedColors) {
        ...
        for (int r = 0; r < expectedColors.length; r++) {
            for (int c = 0; c < expectedColors[0].length; c++) {
                assertEquals("incorrect color at " + COLS[c]
    ...
    public void test9() {
        ...
        PieceColor c = b.getWinner();

        checkBoard(b, TEST9);

        assertEquals(EMPTY, b.getWinner());
    }
    ...
    private static final PieceColor[][] TEST9 = {
            {RED, BLOCKED, BLOCKED, EMPTY, BLOCKED, BLOCKED, BLUE},
            {BLOCKED, BLOCKED, BLOCKED, EMPTY, BLOCKED, BLOCKED, BLOCKED},
            {BLOCKED, BLOCKED, BLOCKED, EMPTY, BLOCKED, BLOCKED, BLOCKED},
            {BLOCKED, BLOCKED, BLOCKED, EMPTY, BLOCKED, BLOCKED, BLOCKED},
            {BLOCKED, BLOCKED, BLOCKED, EMPTY, BLOCKED, BLOCKED, BLOCKED},
            {BLOCKED, BLOCKED, BLOCKED, EMPTY, BLOCKED, BLOCKED, BLOCKED},
            {BLUE, BLOCKED, BLOCKED, EMPTY, BLOCKED, BLOCKED, RED}
    };
